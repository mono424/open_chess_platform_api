...
import 'package:chess_cloud_provider/provider/lichess/models/lichess_game.dart';
...
class LichessEventGameStarted extends LichessEvent {
  ...
  LichessEventGameStarted.fromJson(Map<String, dynamic> json) : super.fromJson(json) {
