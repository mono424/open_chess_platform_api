...
class LichessUserRatings {
  ...
  LichessUserRatings.fromJson(Map<String, dynamic> json) {
    blitz = json['blitz'] != null
        ? LichessRatingInfo.fromJson(json['blitz'])
        : LichessRatingInfo.placeholder;
    bullet = json['bullet'] != null
        ? LichessRatingInfo.fromJson(json['bullet'])
        : LichessRatingInfo.placeholder;
    correspondence = json['correspondence'] != null
        ? LichessRatingInfo.fromJson(json['correspondence'])
        : LichessRatingInfo.placeholder;
    classical = json['classical'] != null
        ? LichessRatingInfo.fromJson(json['classical'])
        : LichessRatingInfo.placeholder;
    rapid = json['rapid'] != null
        ? LichessRatingInfo.fromJson(json['rapid'])
        : LichessRatingInfo.placeholder;
  }
